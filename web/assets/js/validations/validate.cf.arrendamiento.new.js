...
$(function (e) {
    ...
    $('#arrendamiento_anoConstruccion').on('change', function (e) { checkSelect2(this.id, 'Seleccione el año de construcción.'); });
    $('#arrendamiento_estado').on('change', function (e) { checkSelect2(this.id, 'Seleccione el estado.'); });
    ...
    $('#arrendamiento_fechaContrato').on('change', function (e) { checkSelect2('arrendamiento_fechaContrato', 'Seleccione la fecha del contrato.'); });
